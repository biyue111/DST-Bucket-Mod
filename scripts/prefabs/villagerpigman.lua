...
local normalbrain = require "brains/normalpigmanbrain"
...
local function SetNormalPig(inst)
	...
	-- wear strawhat at the beginning
	local strawhat = SpawnPrefab("strawhat")
	inst.components.inventory:Equip(strawhat)
    inst.AnimState:Show("hat")
end
...
return Prefab("villagerpigman", normal, assets, prefabs)
